...
### TODO:
	...
	создать текстовый (*.md) файл (или же ноутбук) в репозитории проекта на гитхабе со ссылкой на данные; 
 в этот же файл необходимо добавить подробное описание датасета: 
 для табличных данных - описание признаков, их тип, 
 количество объектов каждого класса (в задачах классификации), 
 информацию о пропущенных значениях (в т.ч. о типичных филлерах, если это не nan) и т.п.
